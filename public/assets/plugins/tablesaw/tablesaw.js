...
$(document).on("enhance.tablesaw", function() {
	...
	console.log(1768,TablesawConfig);
...
(function() {
	...
	ColumnToggle.prototype.init = function() {
		...
		function onToggleCheckboxChange(checkbox, e) {
		...
		$menu.find('input[type="checkbox"]').on("change", function(e) {
			onToggleCheckboxChange(e.target,e);
			...
			if (self.set.length) {
				...
				$(self.set).each(function() {
					...
					if (checkbox) {
						...
						onToggleCheckboxChange(checkbox,e);
					}
				});
			}
		});
...
(function() {
	...
	$(document).on(Tablesaw.events.create, function(e, tablesaw) {
		...
		if (
			...
			console.log(3561,Tablesaw.events); 
