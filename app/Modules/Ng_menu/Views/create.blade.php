...
<div class="card-body">
    ...
    <div class="block-form">
        <div class="form-group row">
            ...
            <div class="col-md-6 <?php if ($errors->has('slug')) echo 'has-error' ?>">
        ...
        <div class="form-group row">
            <div class="col-md-6 <?php if ($errors->has('parent')) echo 'has-error' ?>">
            ...
            <div class="col-md-6 <?php if ($errors->has('ordering')) echo 'has-error' ?>">
        ...
        <div class="form-group row">
            <div class="col-md-6 <?php if ($errors->has('display')) echo 'has-error' ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6 <?php if ($errors->has('component_link')) echo 'has-error' ?>">
