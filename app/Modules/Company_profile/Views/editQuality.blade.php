...
{{ Form::open(array('route' => $controller_name.'.saveQuality', 'id'=>'form-tab-ajax', 'class'=>'form-validation', 'enctype'=>'multipart/form-data')) }}
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="card-body">
            <div class="title-form">
                Image Company Quality
            </div>
            <div class="block-form">
                <div class="form-group <?php if ($errors->has('photo')) echo 'has-error' ?>">
                    {{ Form::label('Image Company Quality', 'Image Company Quality', array('class'=>'control-label')) }}<br>
