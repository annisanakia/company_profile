    ...
    <section class="section-carousel w-100 position-relative h-100">
        <div class="wrapper-page h-100">
            <div class="carousel-home h-100">
                ...
                <div class="carousel-detail d-lg-flex h-100">
                    <div class="row align-items-lg-center">
                        <div class="col-lg-6 text-center">
                            <img class="img-header" src="{{ asset('assets/images/templates/raw-chicken.jpeg') }}"/><br>
                        </div>
                        <div class="col-lg-6">
                            <div class="carousel-desc text-white">
                                <h2 class="animated slideUp d-3 mb-3 title d-inline-block pb-2">LOREM IPSUM</h2>

                                <p class="animated slideUp d-4">
                ...
                <br>
                <ul class="nav justify-content-center carousel-control">
                    <li class="nav-item text-center active pr-2">
